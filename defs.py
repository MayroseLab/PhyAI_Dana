...
DBSET = "JC"
DIR_PREFIX = "" if DBSET == "1" else "DBset2/" if DBSET == "2" else "validation_set/" if DBSET== "val1" else "validation_set2/" if DBSET == "val2" else "submission_data/"#"starting_trees_ml_minus1/"
SEP = "/"
...
SUBTREE1 = "subtree1"
SUBTREE2 = "subtree2"
DBS = ['protDBs', 'selectome', 'ploiDB', 'TreeBASE']
ROOTLIKE_NAME = "ROOT_LIKE"
SCORES_LST_OLD = ["corr", "best_predicted_ranking", "best_empirically_ranking", "required_evaluations_0.95"]
SCORES_LST = ["corr", "best_empirically_ranking", "best_predicted_ranking"]
...
FEATURES = OrderedDict([("bl", "edge_length"), ("longest", "longest_branch") ,
						#("pdist_p", "pdist_average_pruned"),
						#("pdist_r", "pdist_average_remaining"),
