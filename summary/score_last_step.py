...
if __name__ == '__main__':
	...
	for group_id, df_by_ds in grouped_df_by_ds:
		...
		df = index_rf_scores(df, path, ml_tree)

		#rf_best_pred_by_ds[group_id], rank_rf0_by_ds[group_id] = rf_rank(df)
		#print(rf_best_pred_by_ds[group_id], rank_rf0_by_ds[group_id])

	df.to_csv("/groups/itay_mayrose/danaazouri/PhyAI/DBset2/summary_files/with_preds_merged_20_1_ml_minus1_set_with_RFscore.csv")
